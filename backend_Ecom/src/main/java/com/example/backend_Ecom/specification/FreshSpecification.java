...
/**
 * Xây dựng dynamic query cho filter sản phẩm fresh
 * Cho phép kết hợp các điều kiện filter tùy ý
 */
public class FreshSpecification {
     ...
     * @param category - Loại sản phẩm (VEGETABLE, FRUIT, MEAT, SEAFOOD, DAIRY, HERB)
     * @param region - Khu vực bán (HA_NOI, HO_CHI_MINH, DA_NANG, ...)
     * Ghi chú: Tất cả tham số đều optional (null sẽ bị skip)
     */
    public static Specification<Fresh> advancedSearchCriteria(String name, String description, FreshCategory category, Region region) {
     ...
     * @param categories - Danh sách loại sản phẩm (VEGETABLE, FRUIT, MEAT, ...) - dùng OR logic
     ...
     */
    public static Specification<Fresh> filterByCriteria(List<FreshCategory> categories, Boolean featured, 
