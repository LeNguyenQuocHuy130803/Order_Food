...
@Schema(description = "DTO for paginated food response")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class PaginatedFoodResponseDto {

    @Schema(description = "List of foods in the current page")
    private List<FoodResponseDto> data;
