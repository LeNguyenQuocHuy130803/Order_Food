...
/**
 * Xây dựng dynamic query cho filter sản phẩm dessert
 * Cho phép kết hợp các điều kiện filter tùy ý
 */
public class DessertSpecification {

    /**
     * Xây dựng Specification để filter theo nhiều tiêu chí
     * @param categories - Danh sách loại sản phẩm (CAKE, COOKIE, ICE_CREAM, ...) - dùng OR logic
     ...
     */
    public static Specification<Dessert> filterByCriteria(List<DessertCategory> categories, Boolean featured, 
