...
export function ForgotPasswordForm({ onSuccess }: ForgotPasswordFormProps) {
  ...
  return (
    <div className="w-full max-w-md mx-auto">
      {/* Header */}
      <div className="mb-8">
        <h2 className="text-3xl font-bold text-[#0d0d0d] mb-2">Reset Your Password</h2>
      ...
      {step === 2 && (
        <form onSubmit={handleSubmit2(handleStep2Submit)} className="space-y-6">
          ...
          <div>
            ...
            {errors2.confirmPassword && (
              <p className="text-red-600 text-xs mt-1 font-semibold">{errors2.confirmPassword.message}</p>
            )}
          </div>
